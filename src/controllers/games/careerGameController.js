...
export const saveCareerGameAttempt = async (req, res) => {
  try {
    // console.log("[v0] saveCareerGameAttempt - Starting");
    ...
    // console.log("[v0] Saving career game attempt:", {
    //   userId,
    ...
    console.error("[v0] Error saving career game attempt:", error);
