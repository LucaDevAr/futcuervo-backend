...
export const saveLeagueTeamAttempt = async (req, res) => {
  try {
    console.log("[v0] saveLeagueGameAttempt - Starting");
    ...
    console.log("[v0] Saving league-team game attempt:", {
      userId,
    ...
    console.error("[v0] Error saving league-team game attempt:", error);
