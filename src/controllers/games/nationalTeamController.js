...
export const saveNationalGameAttempt = async (req, res) => {
  try {
    // console.log("[v0] saveNationalGameAttempt - Starting");
    ...
    // console.log("[v0] Saving national-team game attempt:", {
    //   userId,
    ...
    console.error("[v0] Error saving national-team game attempt:", error);
